...
const RegisterForm: FunctionComponent = () => {
  return (
    <>
        <FormContainer>
            <InputContainer>
                <Input placeholder='first name' placeholderTextColor={colors.white}/>
            </InputContainer>
            <InputContainer>
                <Input placeholder='last name' placeholderTextColor={colors.white}/>
            </InputContainer>
            <InputContainer>
                <Input placeholder='email' placeholderTextColor={colors.white}/>
            </InputContainer>
            <InputContainer>
            ...
            <InputContainer>
                <Input placeholder='confirm password' placeholderTextColor={colors.white}/>
            </InputContainer>
        </FormContainer>
